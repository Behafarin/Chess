        ...
        if (destination.piece == null&&destination.j==origin.j) {
            ...
            if (FXMLDocumentController.turn%2 == 1) {
                if (origin.i +1 == destination.i || 
                    ...
                    Image image=new Image(FXMLDocumentController.class.getResourceAsStream(FXMLDocumentController
                            .images[origin.piece.index][FXMLDocumentController.turn%2][destination.color]));
